...
import AlbedoBot.modules.sql.global_bans_sql as gban_sql
import AlbedoBot.modules.sql.users_sql as user_sql
from AlbedoBot import DEV_USERS, NEKO_PTB, OWNER_ID
